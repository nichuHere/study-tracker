            ...
            <div className="glass-card rounded-2xl p-6 shadow-glass">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-1">
                  <button
                    onClick={() => {
                      const unlocked = allBadgesWithStatus.filter(b => b.unlocked);
                      const testBadge = unlocked.length > 0
                        ? unlocked[Math.floor(Math.random() * unlocked.length)]
                        : allBadgesWithStatus[0];
                      if (onTestCelebration) onTestCelebration(testBadge);
                    }}
